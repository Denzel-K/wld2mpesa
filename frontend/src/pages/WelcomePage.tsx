        ...
        <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] flex flex-col p-8 relative overflow-hidden">
            ...
            <div className="flex justify-between items-center z-10 mb-12">
                <div className="flex items-center gap-2">
                    <div className="w-10 h-10 bg-[var(--accent)] rounded-xl flex items-center justify-center shadow-lg shadow-[var(--accent-glow)]">
                        <Zap className="w-6 h-6 text-white" />
                    </div>
                    <span className="font-display font-black text-xl tracking-tight">WLD2Mpesa</span>
                </div>
                <ThemeToggle />
            </div>
            ...
            <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto z-10">
                ...
                >
                    <span className="inline-block px-4 py-1.5 bg-[var(--accent)]/10 text-[var(--accent)] text-xs font-black uppercase tracking-widest rounded-full mb-6">
                        Instant Settlements
                    </span>
                    <h1 className="text-5xl font-black mb-6 tracking-tight font-display leading-[1.1]">
                        Your WLD, <br />
                ...
                <div className="grid grid-cols-1 gap-4 mb-12">
                    <motion.div
                        ...
                        className="flex items-center gap-4 p-4 bg-[var(--bg-secondary)] rounded-2xl border border-[var(--border-color)]"
                    >
                        ...
                        <div>
                            ...
                            <p className="text-xs text-[var(--text-secondary)]">World Chain Native</p>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="text-xs text-[var(--text-secondary)]">Secure Transactions</p>
                        </div>
                    </motion.div>
                </div>
                ...
                <motion.button
                    ...
                    className="btn-mpesa h-16 group relative overflow-hidden"
                >
